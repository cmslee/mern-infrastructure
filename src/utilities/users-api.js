...
//*handle user-related communications with the server bc users-service.js will need to make AJAX requests to the Express server
//all HTTP related logic here...

//!New code: refactored and drier
...
export async function checkToken() {
    //in the return, call the helper function below
...
export async function login(credentials) {
    ...
    //send different data to a different endpoint than signUp
